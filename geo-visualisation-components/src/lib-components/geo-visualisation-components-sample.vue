...
export default /*#__PURE__*/Vue.extend({
  name: 'GeoVisualisationComponentsSample', // vue component name
  data(): SampleData {
    return {
      counter: 5,
      initCounter: 5,
...
<template>
  <div class="geo-visualisation-components-sample">
...
<style scoped>
.geo-visualisation-components-sample {
  display: block;
  width: 400px;
  margin: 25px auto;
...
.geo-visualisation-components-sample p {
  margin: 0 0 1em;
}
</style>
